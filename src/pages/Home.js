...
function Home() {
    ...
    return(
        <div>
            ...
            text-white justify-between max-w-maxContent gap-8">
                ...
                <Link to={"/signup"}>
                    ...
                    transition-all duration-200 hover:drop-shadow-none hover:scale-95 w-fit">
                        <div className="flex flex-row items-center gap-2 rounded-full px-10 py-[5px] transition-all duration-200
                        bg-richblack-800 group-hover:bg-richblack-900">
            ...
            <div className=" bg-pure-greys-5 text-richblack-700">
                <div className="homepage_bg h-[310px]">
                    ...
                    <div className="w-11/12 max-w-maxContent flex flex-col items-center gap-5 mx-auto">
                        ...
                        <div className="flex flex-row gap-7 text-white mt-7">
                            <CTAButton active={true} linkto={"/signup"}>
                        ...
                        <div className="flex flex-row gap-5 mb-10 mt-[80px]">
                            ...
                            <div className="flex flex-col gap-10 w-[40%] items-start">
                                <div className="text-[16px]">
                                    The modern EduHackr is the dictates its own terms. Today, to
